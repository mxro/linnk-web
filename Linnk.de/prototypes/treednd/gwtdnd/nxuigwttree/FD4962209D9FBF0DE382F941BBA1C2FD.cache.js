...
var $strongName = 'FD4962209D9FBF0DE382F941BBA1C2FD';
...
function $initCapturingWidget(this$static){
  ...
  $setPixelSize(this$static.capturingWidget, getClientWidth_2(), getClientHeight_2());
...
function $clinit_29(){
  ...
  false;
  impl_0 = $DOMUtilImplSafari(new DOMUtilImplSafari);
}
...
function $DOMUtilImplSafari(this$static){
  $DOMUtilImplStandard(this$static);
  $$init_32();
  return this$static;
}

function cancelAllDocumentSelections_1(){
...
function getClass_33(){
  return Lcom_allen_1sauer_gwt_dnd_client_util_impl_DOMUtilImplSafari_2_classLit;
}

function getClientHeight_1(elem){
  return elem.clientHeight || 0;
}

function getClientWidth_1(elem){
...
_ = DOMUtilImplSafari.prototype = new DOMUtilImplStandard;
_.cancelAllDocumentSelections = cancelAllDocumentSelections_1;
_.getBorderLeft = getBorderLeft_1;
_.getBorderTop = getBorderTop_1;
_.getClass$ = getClass_33;
_.getClientHeight = getClientHeight_1;
_.getClientWidth = getClientWidth_1;
_.typeId$ = 0;
function $$init_33(){
}
...
function createStackTrace(e){
  ...
  $StackTraceCreator$CollectorChrome(new StackTraceCreator$CollectorChrome).createStackTrace(e);
}
...
function createStackTrace_0(){
  ...
  return $StackTraceCreator$CollectorChrome(new StackTraceCreator$CollectorChrome).collect();
}
...
function fillInStackTrace(t){
  ...
  $StackTraceCreator$CollectorChrome(new StackTraceCreator$CollectorChrome).fillInStackTrace(t);
}
...
function $StackTraceCreator$CollectorChrome(this$static){
...
function collect_1(){
  ...
  res = $collect(this);
  if ($length_0(res) == 0) {
    res = splice($StackTraceCreator$Collector(new StackTraceCreator$Collector).collect(), 1);
  }
  return res;
}
...
function extractName_0(fnToString){
  ...
  if ($startsWith(toReturn, 'at ')) {
    toReturn = $substring(toReturn, 3);
  }
  index = $indexOf_1(toReturn, '[');
  if (index == -1) {
    index = $indexOf_1(toReturn, '(');
  }
  if (index == -1) {
    ...
    toReturn = $trim($substring_0(toReturn, 0, index));
  }
  index = $indexOf_0(toReturn, 46);
  if (index != -1) {
    toReturn = $substring(toReturn, index + 1);
  }
  return $length_1(toReturn) > 0?toReturn:'anonymous';
}
...
function inferFrom_1(e){
  var stack;
  stack = $inferFrom(this, e);
  if ($length_0(stack) == 0) {
    return $StackTraceCreator$Collector(new StackTraceCreator$Collector).inferFrom(e);
  }
   else {
...
function $clinit_65(){
  ...
  impl_1 = $DOMImplSafari(new DOMImplSafari);
}
...
function $DOMImplSafari(this$static){
  $clinit_67();
...
function getScrollLeft_1(doc){
  return $getScrollLeft_1($getBody(doc));
}
...
function getScrollTop_0(doc){
  return $getScrollTop_0($getBody(doc));
}
...
_.getScrollLeft = getScrollLeft_1;
_.getScrollLeft_0 = getScrollLeft_2;
_.getScrollTop = getScrollTop_0;
...
function $addClassName(this$static, className){
  ...
  idx = $indexOf_1(oldClassName, className);
  while (idx != -1) {
    ...
    idx = $indexOf_2(oldClassName, className, idx + 1);
  }
  if (idx == -1) {
...
function $removeClassName(this$static, className){
  ...
  idx = $indexOf_1(oldStyle, className);
  while (idx != -1) {
    ...
    idx = $indexOf_2(oldStyle, className, idx + 1);
  }
  if (idx != -1) {
...
function $clinit_177(){
  ...
  impl_2 = $DOMImplSafari_0(new DOMImplSafari_0);
}
...
function getClientHeight_2(){
  $clinit_184();
  return $getClientHeight(get_0());
}

function getClientWidth_2(){
  $clinit_184();
...
function $DOMImplSafari_0(this$static){
...
function getClass_106(){
  return Lcom_google_gwt_user_client_impl_DOMImplSafari_2_classLit;
}

function DOMImplSafari_0(){
}

_ = DOMImplSafari_0.prototype = new DOMImplStandard_0;
...
function applyTo_0(imageElement){
  impl_7.adjust(imageElement, this.url, this.left, this.top_0, this.width_0, this.height_0);
}

function createElement_1(){
  return impl_7.createStructure(this.url, this.left, this.top_0, this.width_0, this.height_0);
}

function createImage(){
  return $Image(new Image_0, this.url, this.left, this.top_0, this.width_0, this.height_0);
}
