...
var $strongName = 'ADE996939F12FF378D90DDF44CAA3047';
...
function $clinit_63(){
  ...
  impl_1 = $DOMImplIE8(new DOMImplIE8);
}
...
function $DOMImplIE8(this$static){
  $clinit_65();
...
function getAbsoluteLeft_0(elem){
  ...
  return $getBoundingClientRectLeft(elem) + $getScrollLeft_0(doc);
}

function getAbsoluteTop_0(elem){
  var doc;
  doc = $getOwnerDocument(elem);
  return $getBoundingClientRectTop(elem) + $getScrollTop(doc);
}
...
function $clinit_178(){
  ...
  impl_2 = $DOMImplIE8_0(new DOMImplIE8_0);
}
...
function $DOMImplIE8_0(this$static){
...
function getClass_104(){
  return Lcom_google_gwt_user_client_impl_DOMImplIE8_2_classLit;
}

function DOMImplIE8_0(){
}

_ = DOMImplIE8_0.prototype = new DOMImplTrident_0;
...
function initWindowCloseHandler_0(){
  $initHandler(($clinit_194() , INSTANCE_1).initWindowCloseHandler_0().getText(), $WindowImplIE$1(new WindowImplIE$1, this));
}
...
function $clinit_194(){
  ...
  INSTANCE_1 = $com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator(new com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator);
}
...
function $com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator(this$static){
  $Object(this$static);
  $$init_106();
  return this$static;
}
...
function $initWindowCloseHandler(this$static){
  if (isNull(initWindowCloseHandler_1)) {
    initWindowCloseHandler_1 = $com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator$1(new com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator$1, this$static);
  }
  return initWindowCloseHandler_1;
}

function getClass_108(){
  return Lcom_google_gwt_user_client_impl_com_1google_1gwt_1user_1client_1impl_1WindowImplIE_1Resources_1default_1InlineClientBundleGenerator_2_classLit;
}
...
function com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator(){
}

_ = com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator.prototype = new Object_0;
...
function $com_google_gwt_user_client_impl_WindowImplIE_Resources_default_InlineClientBundleGenerator$1(this$static, this$0){
  this$static , this$0;
  $Object(this$static);
  $$init_107();
  return this$static;
...
function doAttachChildren_0(){
  tryCommand(this, ($clinit_204() , attachCommand));
}

function doDetachChildren_0(){
  tryCommand(this, ($clinit_204() , detachCommand));
}
...
function $init(this$static, images, useLeafImages){
  ...
  this$static.focusable = ($clinit_209() , impl_4).createFocusable();
...
function $setFocus(this$static, focus_0){
  if (focus_0) {
    ($clinit_209() , impl_4).focus_0(this$static.focusable);
  }
   else {
    ($clinit_209() , impl_4).blur_0(this$static.focusable);
  }
}
...
function $convertToFullNode_0(item){
  ...
  if (isNull(item.imageHolder)) {
    itemTable = clone_0(($clinit_238() , BASE_INTERNAL_ELEM), true);
...
function $initializeClonableElements(){
  ...
  if (isClient()) {
    $clinit_238() , BASE_INTERNAL_ELEM = createTable();
    contentElem = createDiv();
    tbody = createTBody();
    tr = createTR();
    tdImg = createTD();
    tdContent = createTD();
    appendChild(($clinit_238() , BASE_INTERNAL_ELEM), tbody);
    ...
    setStyleAttribute(($clinit_238() , BASE_INTERNAL_ELEM), 'whiteSpace', 'nowrap');
    $clinit_238() , BASE_BARE_ELEM = createDiv();
    setStyleAttribute(($clinit_238() , BASE_BARE_ELEM), 'padding', '3px');
    appendChild(($clinit_238() , BASE_BARE_ELEM), contentElem);
