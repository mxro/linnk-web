...
var $strongName = 'DEB710EFCBA9E03BFA1C31AC29615D61';
...
function $clinit_29(){
  ...
  false;
  impl_0 = $DOMUtilImplMozillaOld(new DOMUtilImplMozillaOld);
}
...
function $DOMUtilImplMozillaOld(this$static){
  $DOMUtilImplMozilla(this$static);
  $$init_33();
  return this$static;
}

function getClass_34(){
  return Lcom_allen_1sauer_gwt_dnd_client_util_impl_DOMUtilImplMozillaOld_2_classLit;
}

function DOMUtilImplMozillaOld(){
}

_ = DOMUtilImplMozillaOld.prototype = new DOMUtilImplMozilla;
...
function exit(initialEntry){
  if (initialEntry) {
    $flushFinallyCommands(($clinit_58() , INSTANCE_0));
  }
  --entryDepth;
}
...
function $clinit_65(){
  ...
  impl_1 = $DOMImplMozillaOld(new DOMImplMozillaOld);
}
...
function $DOMImplMozillaOld(this$static){
  $clinit_68();
  $DOMImplMozilla(this$static);
  $$init_49();
  return this$static;
}

function $getAbsoluteLeftImpl_0(viewport, elem){
  var doc = elem.ownerDocument;
...
function $getAbsoluteTopImpl_0(viewport, elem){
  var doc = elem.ownerDocument;
  var style = doc.defaultView.getComputedStyle(elem, null);
...
function getAbsoluteLeft_1(elem){
  return $getAbsoluteLeftImpl_0($getViewportElement($getOwnerDocument(elem)), elem);
}

function getAbsoluteTop_1(elem){
  return $getAbsoluteTopImpl_0($getViewportElement($getOwnerDocument(elem)), elem);
}
...
_.getAbsoluteLeft = getAbsoluteLeft_1;
_.getAbsoluteTop = getAbsoluteTop_1;
_.getClass$ = getClass_51;
_.setInnerText = setInnerText_1;
_.typeId$ = 0;
...
function $scrollIntoView(this$static){
  ($clinit_65() , impl_1).scrollIntoView_0(this$static);
}
...
function getDirectionOnElement(elem){
  ...
  if ($equalsIgnoreCase('rtl', dirPropertyValue)) {
    return $clinit_149() , RTL;
  }
   else if ($equalsIgnoreCase('ltr', dirPropertyValue)) {
    return $clinit_149() , LTR;
  }
  return $clinit_149() , DEFAULT;
}
...
function setDirectionOnElement(elem, direction){
  switch ($ordinal(direction)) {
    ...
    case 2:
      {
        if (jsNotEquals(getDirectionOnElement(elem), ($clinit_149() , DEFAULT))) {
...
function fromDouble(value){
  if (isNaN_0(value)) {
    return $clinit_164() , ZERO;
  }
  if (value < -9223372036854775808) {
    return $clinit_164() , MIN_VALUE;
  }
  if (value >= 9223372036854775807) {
    return $clinit_164() , MAX_VALUE;
  }
  if (value > 0) {
...
function fromInt(value){
  ...
  if (value > -129 && value < 128) {
    rebase = value + 128;
    result = ($clinit_163() , boxedValues)[rebase];
    if (jsEquals(result, null)) {
      result = ($clinit_163() , boxedValues)[rebase] = internalFromInt(value);
    }
    return result;
  }
...
function $clinit_178(){
  ...
  impl_2 = $DOMImplMozillaOld_0(new DOMImplMozillaOld_0);
}
...
function getAbsoluteLeft_2(elem){
  $clinit_178();
  return $getAbsoluteLeft(elem);
}

function getAbsoluteTop_2(elem){
  $clinit_178();
...
function getTypeInt(typeName){
  return $eventGetTypeInt_0(($clinit_178() , impl_2 , typeName));
}
...
function onClose(event_0){
  while ($size_1(($clinit_44() , timers)) > 0) {
    $cancel_0(dynamicCast($get_3(($clinit_44() , timers), 0), 65));
  }
}
...
function $$init_101(this$static){
}

function $Window$ClosingEvent(this$static){
  $clinit_186();
  $GwtEvent(this$static);
  $$init_101(this$static);
  return this$static;
}
...
function $DOMImplMozillaOld_0(this$static){
  $DOMImplMozilla_0(this$static);
  $$init_106();
  return this$static;
}

function getClass_108(){
  return Lcom_google_gwt_user_client_impl_DOMImplMozillaOld_2_classLit;
}

function DOMImplMozillaOld_0(){
}

_ = DOMImplMozillaOld_0.prototype = new DOMImplMozilla_0;
...
function $getAbsoluteLeft_0(this$static){
  return getAbsoluteLeft_2($getElement(this$static));
}

function $getAbsoluteTop_0(this$static){
  return getAbsoluteTop_2($getElement(this$static));
}
...
function doAttachChildren_0(){
  tryCommand(this, ($clinit_200() , attachCommand));
}

function doDetachChildren_0(){
  tryCommand(this, ($clinit_200() , detachCommand));
}
...
function get_2(id){
  ...
  if (rootPanels.size_0() == 0) {
    ...
    if ($isRTL_0(getCurrentLocale())) {
      setDirectionOnElement(getRootElement(), ($clinit_149() , RTL));
    }
  }
  if (isNull(elem)) {
...
function $init(this$static, images, useLeafImages){
  ...
  this$static.focusable = ($clinit_205() , impl_4).createFocusable();
...
function $moveFocus(this$static){
  ...
  if (isNotNull(focusableWidget)) {
    ...
    left = getAbsoluteLeft_2(selectedElem) - containerLeft;
    top_0 = getAbsoluteTop_2(selectedElem) - containerTop;
...
function $setFocus(this$static, focus_0){
  if (focus_0) {
    ($clinit_205() , impl_4).focus_0(this$static.focusable);
  }
   else {
    ($clinit_205() , impl_4).blur_0(this$static.focusable);
  }
}
...
function $convertToFullNode_0(item){
  ...
  if (isNull(item.imageHolder)) {
    itemTable = clone_0(($clinit_234() , BASE_INTERNAL_ELEM), true);
...
function $initializeClonableElements(){
  ...
  if (isClient()) {
    $clinit_234() , BASE_INTERNAL_ELEM = createTable();
    contentElem = createDiv();
    tbody = createTBody();
    tr = createTR();
    tdImg = createTD();
    tdContent = createTD();
    appendChild(($clinit_234() , BASE_INTERNAL_ELEM), tbody);
    ...
    setStyleAttribute(($clinit_234() , BASE_INTERNAL_ELEM), 'whiteSpace', 'nowrap');
    $clinit_234() , BASE_BARE_ELEM = createDiv();
    setStyleAttribute(($clinit_234() , BASE_BARE_ELEM), 'padding', '3px');
    appendChild(($clinit_234() , BASE_BARE_ELEM), contentElem);
